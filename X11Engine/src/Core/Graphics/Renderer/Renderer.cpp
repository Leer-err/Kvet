...
void Renderer::render() { auto manager = GraphicsCommunicationManager::get(); }
...
//     vkWaitForFences(device, 1, &frame.render_finished.fence, true,
//     UINT64_MAX); vkResetFences(device, 1, &frame.render_finished.fence);
...
//     auto render_finished = backbuffer.getInternal()->createBarrier(
